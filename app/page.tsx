    ...
    <main>
      ...
      <section className="map-section shell" id="map">
        <div className="section-heading map-heading">
          ...
          <p className="heading-note">Three views of<br />one generation problem.</p>
        </div>
        <div className="map-list">
          ...
          <article className="map-item">
            ...
            <div><p className="map-kicker">PROBABILISTIC VIEW</p><h3>Diffuse the data</h3><p>DDPM · forward and reverse processes</p></div>
            <span className="map-status">1 note</span>
          </article>
          <article className="map-item highlighted">
            <span className="map-dot coral" />
            <div className="map-index">02</div>
            <div><p className="map-kicker">GEOMETRIC VIEW</p><h3>Follow the score</h3><p>Score matching · density gradients</p></div>
            <span className="map-status">1 note</span>
          </article>
          <article className="map-item">
            <span className="map-dot blue" />
            <div className="map-index">03</div>
            <div><p className="map-kicker">TRANSPORT VIEW</p><h3>Move the distribution</h3><p>Flow matching · velocity fields</p></div>
            <span className="map-status">1 note</span>
          </article>
        </div>
      </section>
